...
/**
 * essaymaxwords question renderer class.
 *
 * @package    qtype
...
/**
 * Generates the output for essaymaxwords questions.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaymaxwords_renderer extends qtype_renderer {
    public function formulation_and_controls(question_attempt $qa,
        ...
        $id_es_2 = $inputname_es_2 . '_id';
        $editor_es_2 = $qa->get_question()->responseformat;
        $max_words_es_2 = (!empty($qa->get_question()->responsemaxwords))?$qa->get_question()->responsemaxwords:0;
        ...
        $result .= '<script>     
            ...
            if (typeof item_window == "undefined") {
                ...
                item_window.push({"id":"'.$id_es_2.'", "name":"'.$inputname_es_2.'", "editor":"'.$editor_es_2.'", "min_words":"'.$min_words_es_2.'", "max_words":"'.$max_words_es_2.'", "min_error":"'.$error_min_words.'", "max_error":"'.$error_max_words.'", "question_name":"'.$question_name_es_2.'"}); 
                        
                document.addEventListener("DOMContentLoaded", function(event) { 
                    var btn = document.getElementsByClassName("submitbtns")[0].getElementsByTagName("input")[0]; 
                    var btn1 = document.getElementsByClassName("submitbtns")[0].getElementsByTagName("input")[1];        
                    
                    if (typeof btn !== "undefined") {        
                        btn.addEventListener("click", function(event) {
                            var result = true; 
                            
                            result = checkEditors(item_window);
                ...
                function checkEditors(item_window){  
                    ...
                    for (var i in item_window){
                        ...
                        var TynyText = document.getElementsByName(item_window[i].name)[0].value;
                ...
                function checkNumberOfWordsStringMax(num, s){
                ...
                function checkNumberOfWordsStringMin(num, s){
    ...
    public function manual_comment(question_attempt $qa, question_display_options $options) {
        ...
        return html_writer::nonempty_tag('div', $question->format_text(
                $question->graderinfo, $question->graderinfo, $qa, 'qtype_essaymaxwords',
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_essaymaxwords_format_renderer_base extends plugin_renderer_base {
    /**
...
/**
 * An essaymaxwords format renderer for essaymaxwordss where the student should not enter
 * any inline response.
 *
 * @copyright  2013 Binghamton University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaymaxwords_format_noinline_renderer extends plugin_renderer_base {

    protected function class_name() {
        return 'qtype_essaymaxwords_noinline';
    }
...
/**
 * An essaymaxwords format renderer for essaymaxwordss where the student should use the HTML
 * editor without the file picker.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaymaxwords_format_editor_renderer extends plugin_renderer_base {
    protected function class_name() {
        return 'qtype_essaymaxwords_editor';
    }

    public function response_area_read_only($name, $qa, $step, $lines, $context) {
        return html_writer::tag('div', $this->prepare_response($name, $qa, $step, $context),
                array('class' => $this->class_name() . ' qtype_essaymaxwords_response readonly'));
    }
    ...
    public function response_area_input($name, $qa, $step, $lines, $context) {
        ...
        $output .= html_writer::start_tag('div', array('class' =>
                $this->class_name() . ' qtype_essaymaxwords_response'));
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaymaxwords_format_editorfilepicker_renderer extends qtype_essaymaxwords_format_editor_renderer {
    protected function class_name() {
        return 'qtype_essaymaxwords_editorfilepicker';
    }
...
/**
 * An essaymaxwords format renderer for essaymaxwordss where the student should use a plain
 * input box, but with a normal, proportional font.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaymaxwords_format_plain_renderer extends plugin_renderer_base {
    /**
     * @return string the HTML for the textarea.
     */
    protected function textarea($response, $lines, $attributes) {
        $attributes['class'] = $this->class_name() . ' qtype_essaymaxwords_response';
    ...
    protected function class_name() {
        return 'qtype_essaymaxwords_plain';
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_essaymaxwords_format_monospaced_renderer extends qtype_essaymaxwords_format_plain_renderer {
    protected function class_name() {
        return 'qtype_essaymaxwords_monospaced';
    }
}
